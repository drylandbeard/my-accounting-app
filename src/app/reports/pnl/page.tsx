                      ...
                      <>
                        {getQuartersInRange(startDate, endDate).map((quarter) => (
                          <React.Fragment key={quarter}>
                            ...
                            {showPercentages && (
                              <TableHead className="whitespace-nowrap" style={{ width: `${65 / ((getQuartersInRange(startDate, endDate).length + 1) * 2)}%` }}>
                                %
                              </TableHead>
                            )}
                          </React.Fragment>
                        ...
                        <TableHead
                          className="whitespace-nowrap"
                          style={{ width: `${65 / ((getQuartersInRange(startDate, endDate).length + 1) * (showPercentages ? 2 : 1))}%` }}
                        >
                          Total
                        </TableHead>
